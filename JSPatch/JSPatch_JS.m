...
//  JSPatch
//
//  Created by dacaiguoguo on 16/6/2.
//  Copyright (c) 2016 dacaiguoguo. All rights reserved.
//

#import "JSPatch_JS.h"

NSString * JSPatch_js() {
	#define __jspatch_js_func__(x) #x
	
	// BEGIN preprocessorJSCode
	static NSString * preprocessorJSCode = @__jspatch_js_func__(
var global = this;
(function () {
    var callbacks = {};
    var callbackID = 0;
        ...
        value: function (methodName) {
            ...
            if (methodName.indexOf("performSelector") > -1) {
                if (methodName == "performSelector") {
                    ...
                    if (methodName == "performSelectorInOC") {
                        return function () {
                            var args = Array.prototype.slice.call(arguments);
                            return {
                                __isPerformInOC: 1,
